* Tests
** minimal unit tests
*** TODO write (really) minimal unit tests for compilation
*** TODO write (really) minimal unit tests for ACSL generation
** more evolved tests
*** TODO find interesting tests for verification (cf. Ploc)
    - PID
    - alarm, triplex voter
** TODO classify existing tests
** TODO verify if there are Lustre V4/V6 regression tests
* ACSL backend for C generation
** tests metrics
*** TODO find interesting metrics for tests
...
* Zustre
** TODO restart Zustre development
** TODO compare Zustre with Kind2 on benchmarks
