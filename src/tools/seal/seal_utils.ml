...
let pp_guard_list pp_elem fmt gl =
  (Format.pp_print_list ~pp_sep:Format.pp_print_semicolon (fun fmt (e, b) ->
...
let pp_mdefs pp_elem fmt gel =
  Format.pp_print_list (pp_guard_expr pp_elem) fmt gel
...
let pp_gl pp_expr =
  Format.pp_print_list ~pp_sep:Format.pp_print_comma (fun fmt (e, b) ->
...
let pp_all_defs =
  Format.pp_print_list ~pp_sep:Format.pp_print_comma (fun fmt (id, gel) ->
